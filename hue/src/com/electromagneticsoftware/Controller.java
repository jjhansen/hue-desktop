...
import com.electromagneticsoftware.gui.AccessPointList;
import com.electromagneticsoftware.gui.DesktopView;
import com.electromagneticsoftware.gui.LightColoursFrame;
//import com.electromagneticsoftware.gui.LightList;
import com.electromagneticsoftware.gui.PushLinkFrame;
	...
	private PHSDKListener listener = new PHSDKListener() {
		...
		public void onError(int code, final String message) {
			...
			if (code == PHHueError.BRIDGE_NOT_RESPONDING) {
				...
				if (null != pushLinkDialog && pushLinkDialog.isShowing()) {
					pushLinkDialog.setVisible(false);
					desktopView.showDialog(message);
				}
				else {
